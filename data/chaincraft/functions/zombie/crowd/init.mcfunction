...
execute if predicate chaincraft:chance/20 run function chaincraft:zombie/crowd/head/3
execute if predicate chaincraft:chance/20 run function chaincraft:zombie/crowd/head/4
execute if predicate chaincraft:chance/20 run function chaincraft:zombie/crowd/head/5
# Select weapon

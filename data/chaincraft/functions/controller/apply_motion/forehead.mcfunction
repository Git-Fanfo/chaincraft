...
execute store result entity @s Motion[0] double 0.014 run scoreboard players operation @s motion_x1 -= @s motion_x0
execute store result entity @s Motion[1] double 0.014 run scoreboard players operation @s motion_y1 -= @s motion_y0
execute store result entity @s Motion[2] double 0.014 run scoreboard players operation @s motion_z1 -= @s motion_z0

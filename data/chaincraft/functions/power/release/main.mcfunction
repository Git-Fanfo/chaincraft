...
execute if score acc_blood power >= strength_2 power run summon firework_rocket ~ ~1 ~ {LifeTime:0,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Colors:[I;16711680]},{Type:1,Colors:[I;5768198]},{Type:1,Colors:[I;3474180]},{Type:1,Colors:[I;5768198]},{Type:1,Colors:[I;5768198]},{Type:1,Colors:[I;3474180]},{Type:1,Colors:[I;5768198]},{Type:1,Colors:[I;5768198]},{Type:1,Colors:[I;3474180]}]}}}}

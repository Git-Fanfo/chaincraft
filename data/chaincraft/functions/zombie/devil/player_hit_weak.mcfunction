...
execute if score hit zombie_devil matches 1 run scoreboard players add @s score 15000
#execute if score hit zombie_devil matches 2 run say @s made the second hit! Added 1000 points!
execute if score hit zombie_devil matches 2 run scoreboard players add @s score 25000
#execute if score hit zombie_devil matches 3 run say @s made the final hit! Added 10000 points!
execute if score hit zombie_devil matches 3 run scoreboard players add @s score 500000
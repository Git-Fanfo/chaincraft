...
execute if score intro timer matches 520 as @a[tag=intro_chain] run tellraw @s ["",{"text":"<","color":"#FF6C0A"},{"text":"Chainsaw","color":"#FF6C0A"},{"text":"> ","color":"#FF6C0A"},"I always loved hearing you talk about your dreams."]
execute if score intro timer matches 460 as @a[tag=intro_chain] run tellraw @s ["",{"text":"<","color":"#FF6C0A"},{"text":"Chainsaw","color":"#FF6C0A"},{"text":"> ","color":"#FF6C0A"},{"selector":"@s"},"."]
execute if score intro timer matches 410 as @a[tag=intro_chain] run tellraw @s ["",{"text":"<","color":"#FF6C0A"},{"text":"Chainsaw","color":"#FF6C0A"},{"text":"> ","color":"#FF6C0A"},"Here's the deal. I'll give you my heart."]
execute if score intro timer matches 340 as @a[tag=intro_chain] run tellraw @s ["",{"text":"<","color":"#FF6C0A"},{"text":"Chainsaw","color":"#FF6C0A"},{"text":"> ","color":"#FF6C0A"},"And in exchange, I want you to show me your dream."]
